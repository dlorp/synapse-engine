...
**What Happened:**
- The test `test_discovery_integration.py` is designed to scan a local directory: `/Users/dperez/Documents/LLM/llm-models/HUB`
...
**File:** `/Users/dperez/Documents/Programming/SYNAPSE_ENGINE/backend/tests/test_moderator_analysis.py`
...
scan_path = Path(os.getenv("TEST_MODEL_PATH", "/Users/dperez/Documents/LLM/llm-models/HUB"))
```
