...
**File:** `${PROJECT_DIR}/frontend/src/api/client.ts`
...
**File:** `${PROJECT_DIR}/frontend/src/utils/queryTimeouts.ts`
...
**File:** `${PROJECT_DIR}/frontend/src/hooks/useQuery.ts`
...
- `${PROJECT_DIR}/frontend/src/components/query/QueryInput.module.css`
...
Created comprehensive unit tests in `${PROJECT_DIR}/frontend/src/utils/queryTimeouts.test.ts`:
...
To adjust timeouts in the future, modify the `TIER_TIMEOUTS` constant in `${PROJECT_DIR}/frontend/src/utils/queryTimeouts.ts`:
...
### Created
1. `${PROJECT_DIR}/frontend/src/utils/queryTimeouts.ts` - Timeout utility module
2. `${PROJECT_DIR}/frontend/src/utils/queryTimeouts.test.ts` - Comprehensive tests

### Modified
1. `${PROJECT_DIR}/frontend/src/api/client.ts` - Updated base timeout
2. `${PROJECT_DIR}/frontend/src/hooks/useQuery.ts` - Added tier-specific timeout logic
3. `${PROJECT_DIR}/frontend/src/components/query/QueryInput.tsx` - Added timeout display
4. `${PROJECT_DIR}/frontend/src/components/query/QueryInput.module.css` - Added timeout hint styling
