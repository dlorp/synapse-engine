...
**File:** `/Users/dperez/Documents/Programming/SYNAPSE_ENGINE/backend/Dockerfile`
...
**File:** `/Users/dperez/Documents/Programming/SYNAPSE_ENGINE/docker-compose.yml`
...
Create script: `/Users/dperez/Documents/Programming/SYNAPSE_ENGINE/scripts/start-host-servers.sh`

```bash
#!/bin/bash
# Start llama-server instances on macOS host for Docker development

HUB_PATH="/Users/dperez/Documents/LLM/llm-models/HUB"
...
Modify `/Users/dperez/Documents/Programming/SYNAPSE_ENGINE/backend/app/services/llama_server_manager.py`:
...
- **Update:** `/Users/dperez/Documents/Programming/SYNAPSE_ENGINE/backend/Dockerfile` (add llama.cpp build stage)
- **Update:** `/Users/dperez/Documents/Programming/SYNAPSE_ENGINE/docker-compose.yml` (remove volume mount, update notes)

### Option 3 (Quick Workaround):
- **Update:** `/Users/dperez/Documents/Programming/SYNAPSE_ENGINE/docker-compose.yml` (remove volume mount)
- **Create:** `/Users/dperez/Documents/Programming/SYNAPSE_ENGINE/scripts/start-host-servers.sh` (server launcher)
- **Update:** `/Users/dperez/Documents/Programming/SYNAPSE_ENGINE/backend/app/services/llama_server_manager.py` (host mode)
