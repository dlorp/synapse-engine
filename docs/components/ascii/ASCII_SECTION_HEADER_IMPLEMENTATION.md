...
**File:** `${PROJECT_DIR}/frontend/src/components/terminal/AsciiSectionHeader/AsciiSectionHeader.tsx`
```typescript
...
**File:** `${PROJECT_DIR}/frontend/src/components/terminal/AsciiSectionHeader/AsciiSectionHeader.module.css`
```css
.asciiSectionHeader {
...
**File:** `${PROJECT_DIR}/frontend/src/components/terminal/index.ts`
...
**File:** `${PROJECT_DIR}/frontend/src/components/terminal/Panel/Panel.tsx`
**Changes:** Line 26 - Removed ASCII line generation, restored simple text
```typescript
{title && <div className={styles.title}>{title}</div>}
```

**File:** `${PROJECT_DIR}/frontend/src/components/terminal/Panel/Panel.module.css`
...
**File:** `${PROJECT_DIR}/frontend/src/pages/HomePage/HomePage.module.css`
