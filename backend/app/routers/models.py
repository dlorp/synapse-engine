...
async def enable_all_models() -> BulkEnabledUpdateResponse:
    ...
    try:
        ...
        logger.info(
            f"Bulk enable completed: {models_updated} models enabled",
            extra={"models_updated": models_updated}
        )
    ...
    return BulkEnabledUpdateResponse(
        message=f"All models enabled successfully ({models_updated} updated)",
...
async def disable_all_models() -> BulkEnabledUpdateResponse:
    ...
    try:
        ...
        logger.info(
            f"Bulk disable completed: {models_updated} models disabled",
            extra={"models_updated": models_updated}
        )
    ...
    return BulkEnabledUpdateResponse(
        message=f"All models disabled successfully ({models_updated} updated)",
        models_updated=models_updated,
        enabled=False,
        timestamp=datetime.now(timezone.utc).isoformat()
    )
