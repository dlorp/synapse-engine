...
### 1. `${PROJECT_DIR}/backend/app/models/discovered_model.py`
...
### 2. `${PROJECT_DIR}/backend/app/services/model_discovery.py`
...
### 3. `${PROJECT_DIR}/backend/app/cli/discover_models.py`
