...
class TTEAnimator:
    ...
    def create_effect(
        ...
        effect.terminal_config.ignore_terminal_dimensions = (
            cfg.ignore_terminal_dimensions
        )
        ...
        if effect_type == EffectType.DECRYPT and hasattr(
            effect.effect_config, "typing_speed"
        ):
...
class ThemeTransitionManager:
    ...
    async def transition_to_theme(
        self, theme_name: str, overlay_widget: Static | None = None
    ):
        """
