...
**Location:** `${PROJECT_DIR}/frontend/src/pages/MetricsPage/HistoricalMetricsPanel.tsx`
...
**File:** `${PROJECT_DIR}/frontend/src/pages/MetricsPage/MetricsPage.tsx`
...
**File:** `${PROJECT_DIR}/frontend/src/pages/MetricsPage/index.ts`
...
1. `${PROJECT_DIR}/frontend/src/pages/MetricsPage/HistoricalMetricsPanel.tsx` - Component implementation
2. `${PROJECT_DIR}/frontend/src/pages/MetricsPage/HistoricalMetricsPanel.module.css` - Component styles
3. `${PROJECT_DIR}/frontend/HISTORICAL_METRICS_INTEGRATION.md` - This integration guide
